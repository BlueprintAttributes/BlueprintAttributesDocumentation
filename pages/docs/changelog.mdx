...
## [1.2.0](https://github.com/BlueprintAttributes/BlueprintAttributes/releases/tag/1.2.0) - May 25, 2026

**New Features**

* Expand Exec Calc Blueprint library with new methods in [#124](changelog/pull/124)

**Other Changes**

* Add UE 5.8 compatibility, drop UE 5.3/5.4 support in [#126](changelog/pull/126)

**Full Changelog**: [https://github.com/BlueprintAttributes/BlueprintAttributes/compare/1.1.2...1.2.0](https://github.com/BlueprintAttributes/BlueprintAttributes/compare/1.1.2...1.2.0)
...
* Ensure attributes dropdown filtering handled custom child struct in [#122](changelog/pull/122)
